...
function CalculadoraIntegral() { // Se mantiene el nombre CalculadoraIntegral para coincidir con el archivo
	...
	// --- Renderizado ---
	return (
		// FIX: Se agrega el ID para que el enlace de anclaje de la navegación funcione
		<Container id="calculadorademo" className="my-5"> 
